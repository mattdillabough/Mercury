    ...
    return (
        <Screen>
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.question}>Have you experienced any of the following symptons in the past 48 hours:</Text>
                ...
                <Text style={styles.question}>Have you been in close physical contact in the last 14 days with:</Text>
                <Text>      • Anyone who is known to have laboratory-confirmed COVID-19?</Text>
                ...
                />
                <Text style={styles.question}>Are you isolating or quarantining because you may have been exposed to a person with
                    COVID-19 or are worried that you may be sick with COVID-19?</Text>
                <AppFormChoice
                    name="question3"
                    box={false}
                    data={data}
                ...
                />
                <Text style={styles.question}>Are you currently waiting on the results of a COVID-19 test?</Text>
                <AppFormChoice
                    name="question4"
                    box={false}
                    data={data}
                ...
                />
                <Text style={styles.question}>Have you traveled in the past 10 days?</Text>
                <AppFormChoice
                    name="question5"
                    box={false}
                    data={data}
